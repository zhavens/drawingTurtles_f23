    #Eamon Prokopowich + Eron Lacdao's Code
    #######################################
...
### (PRE CONDITION: top left of a bounding box + must import math) ###
    import math 
    starting_pos = s.yertle.pos()
# using s. [box sizes], I draw my letter WITHIN the bounding box
    s.yertle.down(x.BOX_HEIGHT)
    s.yertle.goto(starting_pos)
    ...
    s.yertle.forward(math.sqrt((s.BOX_WIDTH**2)+(s.BOX_WIDTH**2)))
